...
func TestLoggerDebug(t *testing.T) {
	logger := NewLogger(DebugLevel, NewStandardHandler(os.Stdout, EncoderOf("text"), DefaultTimeFormat))
...
func TestLoggerChangeLevelTo(t *testing.T) {
	logger := NewLogger(WarnLevel, NewStandardHandler(os.Stdout, EncoderOf("text"), DefaultTimeFormat))
