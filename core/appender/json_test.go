...
func TestJsonAppender(t *testing.T) {
	...
	want := `{"any":{"AppendAnyKey1":"value","AppendAnyKey2":123,"AppendAnyKey3":666.666},"bool":true,"byte":"b","rune":"r","int":-1,"int8":-8,"int16":-16,"int32":-32,"int64":-64,"uint":1,"uint8":8,"uint16":16,"uint32":32,"uint64":64,"float32":32.31999969482422,"float64":64.64,"string":"value","duration":"1s",` +
		...
		`6,1234],"uint32s":[32,323232,12345],"uint64s":[64,64646464,123456],"float32s":[32.31999969482422,3232.3232421875,323232.3125],"float64s":[64.64,64.64,64.64],"strings":["value1","value2","value3"],"durations":["1s","2s","3s"],"times":["2006-01-02 15:04:05","2021-10-27 00:38:00"],"errors":["ops1","ops2","ops3"],"stringers":["0.0.0.0","255.25` +
		`5.255.255"]}` + "\n"
	if result != want {
